                ...
                <select class="form-select" id="tags" name="tags[]" multiple="multiple">
                  ...
                  @foreach($tags as $tag)
                      <option value="{{$tag->id}}" 
                        ...
                        @if(in_array($tag->id , $blogs->tags->pluck('id')->toArray()))
                        selected 
                        @endif
                        >
                          {{$tag->name}}</option>
                  ...
                  <div class="col-md-12">
                    <div class="mb-3">
                      ...
                      <textarea name="short_description" value="{{$blogs->short_description}}" class="form-control">{{$blogs->short_description}}</textarea>
                    </div>
                  </div>
